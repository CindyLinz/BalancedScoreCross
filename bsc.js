  ...
  document.querySelector('#bulk_file').onchange = function(ev){
    ...
    if ((that = this.files[0]) != null) {
      ...
      reader.onload = function(rev){
        var archive, sharedStrings, res$, i$, ref$, len$, t, sheet, e, x$, bulkBoard, pivots, input, colors, labels, label, index, row, cols, j$, ref1$, len1$, c, type, value, i, y$, rowBoard, scores, divs, div, canvas;
        try {
